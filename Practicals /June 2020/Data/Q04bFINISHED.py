...
def lowAttendance():
    for x in range(len(pupilAttendance)):
        if pupilAttendance[x-1][2] < 75:
            print( pupilAttendance[x-1][0], pupilAttendance[x-1][1])
    return
...
if option == 1:
    ...
    highatt = highAttendance()
    print("there were ", highatt, " high attendance.")
